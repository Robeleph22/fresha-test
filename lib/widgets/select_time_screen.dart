    ...
    Navigator.of(context).push(
      CupertinoSheetRoute<void>(
        builder: (BuildContext context) {
          return const SelectProfessionalScreen(
...
class _ProfessionalSelectSheet extends StatefulWidget {
  const _ProfessionalSelectSheet();

  @override
  State<_ProfessionalSelectSheet> createState() =>
      _ProfessionalSelectSheetState();
}

class _ProfessionalSelectSheetState extends State<_ProfessionalSelectSheet> {
  ...
  void _onScroll() {
    final isFull = _scrollableController.size >= 0.98;
